...
interface DocumentListItemProps {
  ...
  onSelect: () => void;
  onDelete: () => void;
  onCsvReimport?: (id: number) => void; // NEU: CSV-Reimport Callback
}
    ...
    <li className="py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* NEU: CSV-Reimport Button (nur für Wareneingangs-Dokumente) */}
          {(document.unterkategorie === 'Lieferschein_extern' || document.kategorie === 'berta') && (
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (onCsvReimport) {
                  onCsvReimport(document.id);
                }
              }}
